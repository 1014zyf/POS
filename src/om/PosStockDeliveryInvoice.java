...
public class PosStockDeliveryInvoice {
	...
	public void init() {
		...
		this.createTime = fmt.print(AppGlobal.convertTimeToUTC(createLocTime));
		this.createUserId = 0;
		this.createStatId = 0;
	...
	private void readDataFromJson(JSONObject invoiceJSONObject) {
		...
		this.createTime = resultInvoice.optString("sinv_create_time", oFmt.print(AppGlobal.convertTimeToUTC(createLocTime)));
	...
	public boolean addUpdate(boolean bUpdate, boolean bUpdateOutletTable, PosOutletTable oOutletTable, List<PosStockDeliveryInvoiceItem> oNewItemList, String sBusinessDayId) {
