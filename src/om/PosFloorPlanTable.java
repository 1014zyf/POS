...
public class PosFloorPlanTable {
	private String flrtId;
	private String bdayId;
	private String bperId;
	private int shopId;
	private int oletId;
	private String flrmId;
	private int table;
	...
	public PosFloorPlanTable (String sFlrtId) {
		this.init();
	...
	public void readById (String sFlrtId) {
		this.flrtId = sFlrtId;
	}
	...
	public void setFlrmId(String sFlrmId) {
		this.flrmId = sFlrmId;
	}
