...
public class FuncCoupon {
	...
	public boolean isCouponServerSetupExist() {
		if(m_sServerIPAddress.equals("") || m_iPort == 0 || m_sServerLocale.equals(""))
			return false;
	...
	public void setSellCheck(int iCheckNum) {
		m_sSellCheck = String.valueOf(iCheckNum);
	}
