...
public class PosUserTimeInOutLog {
	...
	private void readDataFromJson(JSONObject userTimeInOutLogJSONObject) {
		...
		this.init();
		this.utioId = resultUserTimeInOutLog.optInt("utio_id");
		this.bdayId = resultUserTimeInOutLog.optInt("utio_bday_id");
	...
	public boolean readByUserId(int iBdayId, int iUserId) {
		JSONObject requestJSONObject = new JSONObject();
	...
	public boolean printUserTimeOutSlip(int iBdayId, int iOletId, int iUserId, int iPrintQueueId, int iLangIndex) {
		JSONObject requestJSONObject = new JSONObject();
		boolean bResult = false;
	...
	public void setBusinessDayId(int iBdayId) {
		this.bdayId = iBdayId;
	}
