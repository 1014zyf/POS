...
public class PosDiscountType {
	...
	public JSONArray readAllByItemDiscGrpAndOutletId(int itemDiscGrpId, int outletId, String sBusinessDay, boolean bIsHoliday, boolean bIsDayBeforeHoliday, boolean bIsSpecialDay, boolean bIsDayBeforeSpecialDay, int iWeekday, List<Integer> oUserGrpIds) {
	...
	public JSONArray readAllByIOutletId(String sDiscountType, int outletId, String sBusinessDay, boolean bIsHoliday, boolean bIsDayBeforeHoliday, boolean bIsSpecialDay, boolean bIsDayBeforeSpecialDay, int iWeekday, List<Integer> oUserGrpIds) {
		JSONObject requestJSONObject = new JSONObject(), tmpJSONObject;
		JSONArray responseJSONArray = null, tmpJSONArray = new JSONArray();
