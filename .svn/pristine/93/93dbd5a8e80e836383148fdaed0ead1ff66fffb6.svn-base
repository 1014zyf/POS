...
public class PosConfig {
	...
	public static String BOOLEAN_VALUE_YES = "y";
	public static String BOOLEAN_VALUE_NO = "";
	...
	public boolean getEmployeeUserLimit(int iStatId, int iOutletId, int iShopId, String sVariable, String userId) {
		JSONObject requestJSONObject = new JSONObject();
		...
		try {
			...
			requestJSONObject.put("outletId", iOutletId);
			requestJSONObject.put("shopId", iShopId);
			requestJSONObject.put("section", "user_limit");
			requestJSONObject.put("variable", sVariable);
			requestJSONObject.put("userId", userId);
		}catch (JSONException jsone) {
				jsone.printStackTrace();
		}
		return this.readDataFromApi("gm", "pos", "getEmployeeUserLimit", requestJSONObject.toString());   
	}
