...
public class PosOrderItemAcl {
	...
	public boolean checkRulesCondition(Date dBusinessDate, int iWeekday, boolean bSpecialDay, boolean bBeforeSpecialDay, boolean bHoliday, boolean bBeforeHoliday) {
